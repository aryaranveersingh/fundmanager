...
function curl($url,$hosts,$post) {

    $ch = curl_init();
    // $cookie = "Cookie:JSESSIONID=T9vkVfyFhCZ9wmrFmsBwmTZVrcW1pQD5jlm7jgSCdmTZ5qGQ5sGS!-406108419!-1994040270; visid_incap_188096=QAV/edWsSIWH9Ea7nXQT/79yn1UAAAAAQUIPAAAAAADeM0yNF1hA+HHMlazmSQIK; incap_ses_219_188096=TVsnfK/fnkwvy3qtdwwKA79yn1UAAAAA3syujoxNFT9EWs8DuuTeAg==; _ga=GA1.3.725555002.1436512962; BIGipServerpool_jobsbank.gov.sg_80_ipv4=1041294858.20480.0000; _gat=1";
    ...
    // curl_setopt($ch, CURLOPT_PROXY, '207.91.10.234:8080');
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_AUTOREFERER, true);
    if($post == 1){
        $post = "{actionForm.checkValidRequest}=YES";
        curl_setopt($ch, CURLOPT_POST, 1);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post); 
    }
    curl_setopt($ch, CURLOPT_USERAGENT,getRandomUserAgent());
    curl_setopt($ch,CURLOPT_COOKIEJAR,"thaipost.txt"); 
    curl_setopt($ch,CURLOPT_COOKIEFILE,"thaipost.txt");        
...
function getRandomProxies(){
    //'8.29.210.46:3128','72.159.133.64:3128',37.187.253.39:8123,"54.214.234.21:4444" 104.235.29.75:3128
    $ar = array('198.46.246.51:3128','54.214.233.179:4444',"54.214.234.18:4444","54.68.35.114:3128");
    // $ar = array('212.46.199.10:8080',"8.12.162.98:8080","52.26.57.213:3128","72.159.133.65:3128","23.97.182.128:3128","5.135.159.162:8888","72.159.133.64:3128","52.26.50.10:3128");
    // $ar = array('162.209.2.203:31280','166.78.136.14:31280','162.213.38.225:31280','173.230.133.30:31280');
    $key = $ar[rand(0,3)];
    return $key;
}
...
function file_get_html($url, $use_include_path = false, $context = false, $offset = -1, $maxLen = -1, $lowercase = true, $forceTagsClosed = true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN = true, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT) {
    ...
    $contents = curl($url,$host,$postdata);
