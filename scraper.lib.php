...
function curl($url,$host) {
    // u=https://www.graypools.com/fund-manager/801-73728&b=13&f=norefer
    // echo $url = 'http://proxymesh.com/web/browse.php?'.'u='.$url.'&b=29&f=norefer';
    // $serverIP = rand(1,4);
    // echo $url = 'http://'.$serverIP.'.hidemyass.com/includes/process.php?action=update&idx=3';
    $ch = curl_init();
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, array('Accept:  text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8', 'Host:'.$host));
